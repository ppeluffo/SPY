#!/usr/bin/python3 -u
#  DLGID=TEST01&TYPE=INIT&VER=2.0.6&PLOAD=CLASS:COUNTER;C0:CNTA,1.000,100,10,0;C1:CNT1,1.000,100,10,0


from spy_log import log
from spy_utils import u_send_response
from spy_conf_counter import Confcounter

# ------------------------------------------------------------------------------

class RAW_INIT_COUNTER_frame:
    '''
    ...
    def send_response(self):
        pload = 'CLASS:COUNTER;{}'.format(self.response_pload)
    ...
    def process(self):
        ...
        # Creo una configuracion tipo 'counter' vacia
        # y la cargo con los datos del datalogger.
        conf_from_dlg = Confcounter(self.dlgid)
        ...
        conf_from_bd = Confcounter(self.dlgid)
