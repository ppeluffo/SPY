#!/usr/bin/python3 -u
#  DLGID=TEST01&TYPE=INIT&VER=2.0.6&PLOAD=CLASS:RANGE;R0:DIST1


from spy_log import log
from spy_utils import u_send_response
from spy_conf_range import Confrange

# ------------------------------------------------------------------------------

class RAW_INIT_RANGE_frame:
    '''
    ...
    def send_response(self):
        pload = 'CLASS:RANGE;{}'.format(self.response_pload)
    ...
    def process(self):
        ...
        conf_from_dlg = Confrange(self.dlgid)
        ...
        conf_from_bd = Confrange(self.dlgid)
